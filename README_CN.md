...
返回字段|字段说明
-|-
code|状态编码，200-成功无异常,506-code参数错误
data|数据返回，无数据则为空，具体数据类型参考如下
msg|返回信息
...
返回字段|字段说明
-|-
code|状态编码，200-成功无异常,506-code参数错误，507-type参数错误,508-获取K线数据失败
data|数据返回，无数据则为空，具体数据类型参考如下
msg|返回信息
...
返回字段|字段说明
-|-
code|状态编码，200-成功无异常，506-资产余额不足,507-交易委托失败
...
返回字段|字段说明
-|-
code|状态编码，200-成功无异常,506-没有订单,507-订单不属于该用户
data|数据返回，无数据则为空，具体数据类型参考如下
msg|返回信息
